...
public class ExampleTest {
    ...
    public void setUp() {
        ...
        expectedReverse4 = "ssap yllufsseccus dluohs sdohtem tset lla ,dehsinif era uoy nehW";
    }
    ...
    public void testReverseMessage4() {
        String actual = main.reverse("When you are finished, all test methods should successfully pass");
